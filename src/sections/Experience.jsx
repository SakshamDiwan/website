                ...
                return (
                  <div key={experience.id} className='work-content_container group'>
                    ...
                    <div className='sm:p-5 px-2.5 py-5'>
                      ...
                      <p className='text-sm mb-5'>{experience.pos} -- {experience.duration}</p>
                      <p className='group-hover:text-white transition ease-in-out duration-500'>{experience.title}</p>
                    </div>
                  </div>
                )
            })}
