  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await emailjs.send(
        ...
        {
          from_name: form.name,
          to_name: 'Saksham Diwan',
          from_email: form.email,
          to_email: 'sakshamcollege@gmail.com',
        ...
        <div className='contact-container'>
          ...
          <form ref={formRef} onSubmit={handleSubmit} className='mt-12 flex flex-col space-y-7'>
            ...
            <label className='space-y-3'>
              ...
              <textarea name="message" value={form.message} onChange={handleChange} required rows={5}className='field-input' placeholder="Hi, I'm reaching out to ..." />
            </label>
